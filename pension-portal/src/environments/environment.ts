export const environment = {
  ...
  pensionEnrollmentsApiUrl: 'https://iceapay.agriflowhub.xyz/api/v1/pension-enrollments',
  // placeholder until the real countries endpoint is shared
  countriesApiUrl: 'https://iceapay.agriflowhub.xyz/api/v1/countries',
};
